...
for nd in NEEDLES:
    ...
    t1=time.time(); _,I=idxm.search(qv.astype(np.float32).reshape(1,-1),len(raw)); tim['bm25']+=time.time()-t1
...
with open('winnex_v56_results.json','w') as f: json.dump(out,f,indent=2,ensure_ascii=False)
